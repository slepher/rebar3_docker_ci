...
- The `0.1.1` release runs the plugin on Erlang/OTP 27 or newer.
- The `otp-19-0.1.1` release preserves a host plugin compatible with OTP 19.
...
Use the `otp-19` branch and `otp-19-0.1.1` tag when the developer machine itself
must run OTP 19.
